...
export function SelectedBasketPanel2({
    ...
    const selectedBasketData = useMemo(() => {
        ...
        return {
            id: "on-chain",
            title: tokenMetadata?.name || "Basket",
            description: tokenMetadata?.symbol || "On-chain Basket",
            gradient: "from-blue-500 to-purple-500",
            icon: function DynamicIcon() {
    ...
    }, [selectedBasketData, basketChainId]);
    ...
    // Native currency symbol of the basket's chain
