        ...
        <Dialog open={open} onOpenChange={setOpen}>
                ...
                >
                    {value ? (
                        <>
                            ...
                            />
                            <span className="font-semibold text-gray-900 dark:text-gray-100">{value.symbol}</span>
                        </>
                    ) : (
            ...
            >
                <DialogHeader className="px-2">
                    <DialogTitle className="text-left text-lg font-semibold">Select a token</DialogTitle>
                </DialogHeader>
                            ...
                            {filteredTokens.map((token) => (
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        "active:scale-[0.98]",
                                        value?.symbol === token.symbol && "bg-gray-100 dark:bg-gray-700",
                                    )}
                                    onClick={() => {
                                        onChange(token);
                                        setOpen(false);
