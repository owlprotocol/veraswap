...
export function tokenRegistryDataQueryOptions({blockchain, address, registry} :{
    blockchain: string,
    address: Address,
    registry: string
}) {
...
export function tokenRegistryDataQueryKey({blockchain, address, registry} :{
    blockchain: string,
    address: Address,
    registry: string
}) {
...
export async function tokenRegistryData({blockchain, address, registry} :{
    blockchain: string,
    address: Address,
    registry?: string
