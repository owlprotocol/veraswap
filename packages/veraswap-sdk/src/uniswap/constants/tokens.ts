...
export const USDC_SEPOLIA = new Token(sepolia.id, "0x1c7d4b196cb0c7b01d743fbc6116a902379c7238", 6, "USDC", "USD//C");
...
export const USDT = new Token(mainnet.id, "0xdAC17F958D2ee523a2206206994597C13D831ec7", 6, "USDT", "Tether USD");

export const USDC_MAINNET = new Token(mainnet.id, "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", 6, "USDC", "USD//C");

export const USDC = new Token(mainnet.id, "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", 6, "USDC", "USD//C");

export const USDC_OPTIMISM = new Token(optimism.id, "0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85", 6, "USDC", "USD//C");
...
export const USDC_BASE = new Token(base.id, "0x833589fcd6edb6e08f4c7c32d4f71b54bda02913", 6, "USDC", "USD Coin");

export const BTC_BSC = new Token(bsc.id, "0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c", 18, "BTCB", "BTCB");

export const USDC_BNB = new Token(bsc.id, "0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d", 18, "USDC", "USDC");

export const USDT_BNB = new Token(bsc.id, "0x55d398326f99059ff775485246999027b3197955", 18, "USDT", "TetherUSD");

export const USDC_BSC = new Token(bsc.id, "0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d", 18, "USDC", "USDC");

export const USDT_BSC = new Token(bsc.id, "0x55d398326f99059fF775485246999027B3197955", 18, "USDT", "USDT");

export const ETH_BSC = new Token(bsc.id, "0x2170Ed0880ac9A755fd29B2688956BD959F933F8", 18, "ETH", "Ethereum");

export const BUSD_BSC = new Token(bsc.id, "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56", 18, "BUSD", "BUSD");

export const DAI_BSC = new Token(bsc.id, "0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3", 18, "DAI", "DAI");
...
export const USDC_POLYGON = new Token(polygon.id, "0x3c499c542cef5e3811e1192ce70d8cc03d5c3359", 6, "USDC", "USD Coin");
...
export const USDB_BLAST = new Token(blast.id, "0x4300000000000000000000000000000000000003", 18, "USDB", "USDB");

export const ARB = new Token(arbitrum.id, "0x912CE59144191C1204E64559FE8253a0e49E6548", 18, "ARB", "Arbitrum");
...
export const USDC_ARBITRUM = new Token(arbitrum.id, "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", 6, "USDC", "USD//C");
...
export const CELO_CELO = new Token(celo.id, "0x471EcE3750Da237f93B8E339c536989b8978a438", 18, "CELO", "Celo");
...
export const USDC_CELO = new Token(celo.id, "0xceba9300f2b948710d2653dd7b07f33a8b32118c", 6, "USDC", "USD Coin");

export const CUSD_CELO = new Token(celo.id, "0x765DE816845861e75A25fCA122bb6898B8B1282a", 18, "cUSD", "Celo Dollar");

export const USDC_ZORA = new Token(zora.id, "0xCccCCccc7021b32EBb4e8C08314bD62F7c653EC4", 6, "USDC", "USD Coin");
...
export const USDC_ZKSYNC = new Token(zksync.id, "0x1d17CBcF0D6D143135aE902365D2E5e2A16538D4", 6, "USDC", "USDC");

export const WBTC = new Token(mainnet.id, "0x2260fac5e5542a773aa44fbcfedf7c193bc2c599", 8, "WBTC", "Wrapped BTC");
...
export const WRAPPED_NATIVE_CURRENCY: Record<number, Token> = {
    ...
    [base.id]: new Token(base.id, "0x4200000000000000000000000000000000000006", 18, "WETH", "Wrapped Ether"),
    [blast.id]: new Token(blast.id, "0x4300000000000000000000000000000000000004", 18, "WETH", "Wrapped Ether"),
    [bsc.id]: new Token(bsc.id, "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c", 18, "WBNB", "Wrapped bsc"),
    [celo.id]: new Token(celo.id, "0x471ece3750da237f93b8e339c536989b8978a438", 18, "CELO", "Celo native asset"),
    // [monadTestnet.id]: new Token(
    //     monadTestnet.id,
    ...
    //     "Wrapped Monad",
    // ),
    [optimism.id]: new Token(optimism.id, "0x4200000000000000000000000000000000000006", 18, "WETH", "Wrapped Ether"),
    [polygon.id]: new Token(polygon.id, "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270", 18, "WMATIC", "Wrapped MATIC"),
    [sepolia.id]: new Token(sepolia.id, "0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14", 18, "WETH", "Wrapped Ether"),
    // [unichain.id]: new Token(unichain.id, "0x4200000000000000000000000000000000000006", 18, "WETH", "Wrapped Ether"),
    ...
    [zksync.id]: new Token(zksync.id, "0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91", 18, "WETH", "Wrapped Ether"),
    [zora.id]: new Token(zora.id, "0x4200000000000000000000000000000000000006", 18, "WETH", "Wrapped Ether"),
};
