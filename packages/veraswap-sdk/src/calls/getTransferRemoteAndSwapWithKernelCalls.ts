...
import { GetSwapCallsParams } from "../swap/getSwapCalls.js";

export interface GetTransferRemoteAndSwapWithKernelCallsParams extends GetSwapCallsParams {
 ...
 * @param params
 */
export async function getTransferRemoteAndSwapWithKernelCalls(
    queryClient: QueryClient,
    wagmiConfig: Config,
    params: GetTransferRemoteAndSwapWithKernelCallsParams,
