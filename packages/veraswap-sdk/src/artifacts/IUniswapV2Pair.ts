...
export const sync = { type: "function", name: "sync", inputs: [], outputs: [], stateMutability: "nonpayable" } as const;
export const token0 = {
    type: "function",
    name: "token0",
    inputs: [],
...
export const events = [Approval, Burn, Mint, Swap, Sync, Transfer] as const;
