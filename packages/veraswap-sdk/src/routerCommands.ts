...
export const COMMAND_DEFINITION = {
  ...
  [CommandType.V4_SWAP]: { parser: Parser.V4Actions, params: [
...
export class RoutePlanner {
  ...
  addCommand<T extends CommandType>(type: T, parameters: AbiParametersToPrimitiveTypes<typeof COMMAND_DEFINITION[T]["params"]>, allowRevert = false): RoutePlanner {
...
export function createCommand<T extends CommandType>(type: T, parameters: AbiParametersToPrimitiveTypes<typeof COMMAND_DEFINITION[T]["params"]>): RouterCommand {
